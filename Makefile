...
.PHONY: build init-project init bash lab-server documentation-server test lint_check lint_check_parallel type_check format format_check build_ext precommit precommit_docker publish
